...
<?php
  ...
  $user_id=$_GET['user_id'];  //find user you want to edit
  $result=mysqli_query($conn,"SELECT * FROM users WHERE user_id='$user_id'");
  $row=mysqli_fetch_assoc($result);

  if(isset($_POST['submit']))   //show the results you want to edit
  {
  ...
  //Update info
  $sql="UPDATE users SET user_id='$user_id',password='$password',name='$name',acc_commision='$acc_commision',address='$address' WHERE user_id='$user_id'";

  if(mysqli_query($conn,$sql)){
  //reload page
   header("location:EditAssociate.php");
 }
 }
?>
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    <a class="navbar-brand" href="#">Edit Sale Associate Data</a>
...
<tr>
 <td>ID :</td>
 <td><input type="text" name="user_id" value="<?= $row['user_id']; ?>" required></td>
</tr>
<tr>
  <td>Password :</td>
...
<tr>
  <td>Commission :</td>
  <td><input type="text" name="acc_commision" value="<?= $row['acc_commision']; ?>" required></td>
</tr>
<tr>
  <td>Address :</td>
