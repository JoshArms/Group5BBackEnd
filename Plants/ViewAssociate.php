...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    <a class="navbar-brand" href="#">View Sale Associate Data</a>
...
<body>
 <h2 style="color:white;"class="content-subhead">Sales Associate Information</h2>
...
<?php
  ...
  if(mysqli_num_rows($result)>0)   //if results has more than 1 info 
  {
